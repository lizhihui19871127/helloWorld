...
(function(window, document, undefined) {
    ...
    var defaults = {
        messages: {
            ...
            matches: '%s与%s不匹配',
            "default": '请选择%s',
            valid_email: '%s不是合法的Email格式',
            valid_emails: '%s必须全部为合法的Email格式',
            min_length: '%s长度必须大于等于%s',
            max_length: '%s长度必须小于等于%s',
            exact_length: '%s长度必须等于%s',
            ...
            integer: '%s只能包含整数',
            decimal: '%s只能包含十进制数',
            is_natural: '%s只能包含自然数0-9',
            is_natural_no_zero: '%s只能包含自然数1-9',
            valid_ip: '%s必须包含合法的IP地址',
            valid_base64: '%s必须包含合法的base64字符',
            valid_credit_card: '%s必须包含合法的银行卡号',
            is_file_type: '%s必须只能为%s格式的文件',
            valid_url: '%s必须包含合法的URL地址',
            valid_phone : '%s格式不合法',
            valid_tel_phone : '%s格式不合法',
