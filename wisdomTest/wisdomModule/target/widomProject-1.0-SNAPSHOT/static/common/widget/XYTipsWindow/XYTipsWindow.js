define('common:widget/XYTipsWindow/XYTipsWindow.js', function(require, exports, module){ var jQuery = require("common:widget/jquery/jquery.js");
/*
...
;(function(){
	...
	$.extend(XYTipsWindow,{
		...
		init: function (o){
            ...
            $(document).off("click","#" + o.___boxID + " .___closeBox");
            $(document).on("click","#" + o.___boxID + " .___closeBox",function(){
				XYTipsWindow.removeBox();
            });
			$(".___closeBox",$box).css({zIndex:"870618"});

			if(o.___closeID != ""){
                $(document).off("click","#" + o.___closeID);
                $(document).on("click","#" + o.___closeID,function(){
                        XYTipsWindow.removeBox();
                });
			};
			if(o.___time != "") {
            ...
            $(document).off("mouseenter","#" + o.___boxID);
            $(document).on("mouseenter","#" + o.___boxID,function(){
				BOXID = o;
            });
		},
		getID: function(){
		...
		setBoxzIndex: function (o) {
            ...
            $(document).off("click","#" + o.___boxID + "parent");
            $(document).on("click","#" + o.___boxID + "parent",function(){
