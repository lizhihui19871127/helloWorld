...
function changeTradePassword() {
    ...
    $.ajax({
        type: "post",
        url: "/main/personalCenter/changeTradePassword",
        async: false,
        data: {"oldPassword": $('#loginPwd').val(), "newPassword": $("#newLoginPwd").val(),"verifyCode":$("#verifyCode").val(),"mobilePhone":$("#mobilePhone").val()},
